...
- Interfaz creada con Vue 3 + Vite (JavaScript, Vue Router, Pinia). Compila, pero todavía no tiene pantallas (ver `interfaz.md`).
...
- [ ] Elegir la librería de UI, CSS e iconos, y el cliente HTTP.
